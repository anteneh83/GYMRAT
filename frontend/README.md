# GymX - Fullstack Gym Trainer & Trainee Management

This workspace contains two parts:

- `backend/` — Node.js + Express + MongoDB API
- `next-frontend/` — Next.js + TailwindCSS frontend
...
The frontend proxies `/api/*` to `http://localhost:5000/api/*` during development.
