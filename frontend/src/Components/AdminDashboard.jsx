    ...
    return (
        <div className="dashboard-container">
            ...
            <div className="contact-form-section" style={{ marginTop: '50px', marginBottom: '50px' }}>
                ...
                <form onSubmit={handleRegisterTrainer} className="trainer-registration-form">
                    ...
                    <textarea placeholder="Bio" value={trainerData.bio} onChange={e => setTrainerData({ ...trainerData, bio: e.target.value })} className="trainer-bio-textarea"></textarea>
                    <button type="submit" disabled={isRegistering} className="pr-btn trainer-submit-btn">
